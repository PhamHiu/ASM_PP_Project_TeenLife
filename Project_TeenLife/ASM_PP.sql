...
-- 2. Tạo bảng Feedbacks (Dùng FbStatus)
CREATE TABLE Feedbacks (
    FeedbackID INT IDENTITY(1,1) PRIMARY KEY,
    UserID INT NOT NULL,
    ProviderID INT NOT NULL,
    FbTitle NVARCHAR(150),
    FbNote NVARCHAR(MAX),
    FbRating INT,
    FbStatus NVARCHAR(20) DEFAULT 'Pending', -- Đã đổi tên
    CreatedAt DATETIME DEFAULT GETDATE(),
    
    CONSTRAINT FK_Feedbacks_Users FOREIGN KEY (UserId) REFERENCES Users(UserId),
    CONSTRAINT FK_Feedbacks_Providers FOREIGN KEY (ProviderId) REFERENCES Providers(ProviderId)
);
GO

-- 3. Tạo bảng Recommends (Dùng ReStatus)
CREATE TABLE Recommends (
    RecommendID INT IDENTITY(1,1) PRIMARY KEY,
    UserID INT NOT NULL,
    ReProvider NVARCHAR(150),
    ReAddress NVARCHAR(255),
    ReCategoryId INT,
    ReTitle NVARCHAR(150),
    ReNote NVARCHAR(MAX),
    ReRating INT,
    ReStatus NVARCHAR(20) DEFAULT 'Pending', -- Đã đổi tên
    CreatedAt DATETIME DEFAULT GETDATE(),

    CONSTRAINT FK_Recommends_Users FOREIGN KEY (UserId) REFERENCES Users(UserId),
    CONSTRAINT FK_Recommends_Categories FOREIGN KEY (ReCategoryId) REFERENCES ProviderCategories(CategoryId)
);
GO
...
-- Thêm cột Rating (cho phép NULL vì không phải feedback nào cũng có sao)
...
(N'phamquanghieu', N'123456', N'Phạm Quang Hiếu ', N'ngoc@gmail.com', N'Admin', NULL),
(N'phamquanghieu_sv', N'123456', N'Phạm Quang Hiếu', N'ngoc@gmail.com', N'Student', N'SV002');

INSERT INTO Users (Username, PasswordHash, FullName, Email, Role, StudentCode)
VALUES
(N'hieu', N'$2a$11$SbDfEDyOvMn1P9pEQ5giLeARYelgP0HD/ZSGFkFAIdmTqCb2Hl2
', N'admin ', N'admin@gmail.com', N'Admin', NULL);
